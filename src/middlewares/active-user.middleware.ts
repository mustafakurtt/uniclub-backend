 ...
 *
 * Durum, RBAC cache'inden (resolveAuthz) okunur; hesap durumu değiştiğinde ilgili
 * servis cache'i invalidate ettiği için ekstra DB sorgusu çoğu istekte yapılmaz.
 */
