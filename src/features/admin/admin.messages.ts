...
export const adminMessages = defineCatalog({
  tr: {
    ...
    "admin.revisionNoteRequired": "Revizyon gerekçesi zorunludur.",
    ...
    "admin.applicationFound": "Başvuru bulundu.",
    "admin.applicationApproved": "Başvuru onaylandı ve kulüp oluşturuldu.",
    "admin.applicationRejected": "Başvuru reddedildi.",
    "admin.applicationRevisionRequested": "Revizyon talebi gönderildi.",
    "admin.applicationHistoryListed": "Başvuru geçmişi listelendi.",
    "admin.formationProposalsListed": "Kuruluş önerileri listelendi.",
    "admin.formationProposalFound": "Kuruluş önerisi bulundu.",
    "admin.formationProposalNotFound": "Kuruluş önerisi bulunamadı.",
    "admin.clubsListed": "Kulüpler listelendi.",
    "admin.clubFound": "Kulüp bulundu.",
    ...
    "admin.announcementsListed": "Duyurular listelendi.",
    "admin.galleryListed": "Galeri listelendi.",
    "admin.activitiesListed": "Etkinlikler listelendi.",
  ...
  en: {
    ...
    "admin.revisionNoteRequired": "A revision reason is required.",
    ...
    "admin.applicationFound": "Application found.",
    "admin.applicationApproved": "Application approved and club created.",
    "admin.applicationRejected": "Application rejected.",
    "admin.applicationRevisionRequested": "Revision request sent.",
    "admin.applicationHistoryListed": "Application history listed.",
    "admin.formationProposalsListed": "Formation proposals listed.",
    "admin.formationProposalFound": "Formation proposal found.",
    "admin.formationProposalNotFound": "Formation proposal not found.",
    "admin.clubsListed": "Clubs listed.",
    "admin.clubFound": "Club found.",
    ...
    "admin.announcementsListed": "Announcements listed.",
    "admin.galleryListed": "Gallery listed.",
    "admin.activitiesListed": "Activities listed.",
