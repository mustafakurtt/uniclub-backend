...
export const tenantsMessages = defineCatalog({
  tr: {
    ...
    "platform.invitePermissionRequired": "İlk yönetici provision için platform.tenant.invite yetkisi gerekir.",
    // başarı
    ...
    "platform.adminInvited": "Tenant yöneticisi oluşturuldu.",
  },
  en: {
    // error
    ...
    "platform.invitePermissionRequired": "platform.tenant.invite permission is required to provision the initial admin.",
    // success
    ...
    "platform.adminInvited": "Tenant administrator created.",
  },
});
