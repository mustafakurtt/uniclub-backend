...
- [ ] `docs/reference/api.md` ve frontend ekibi bilgilendirildi (yeni slug/domain)

---

## İlgili dokümanlar

- [api.md — University](../reference/api.md#3-university--apiuniversities)
...
- [runbook.md](runbook.md) — deploy ve yedekleme
