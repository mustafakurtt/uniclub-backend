# 05 — Eksikler ve Önerilen Endpoint'ler (tarihsel kayıt)

> **Arşiv:** Tüm maddeler Temmuz 2026'da uygulandı. Güncel endpoint referansı:
> [integration/admin-panel.md](../../integration/admin-panel.md).
...
[GUVENLIK_YOL_HARITASI.md §1.3](../../planning/security-core.md).
...
[GUVENLIK_YOL_HARITASI.md §1.3](../../planning/security-core.md) (session epoch /
jti denylist).
