...
> Genel zarf/hata/i18n kuralları için `docs/reference/api.md → Genel Kurallar` ve
> `docs/reference/error-and-audit.md`. Bu doküman yalnızca moderation endpoint'lerini anlatır.
