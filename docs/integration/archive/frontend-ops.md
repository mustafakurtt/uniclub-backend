# Frontend: Ortamlar, Deploy ve Backend Entegrasyonu (arşiv)

> **Not:** Bu belge `uniclub-frontend` reposuna aittir; backend repoda referans
> olarak tutulur. Güncel backend ops: [operations/runbook.md](../../operations/runbook.md),
> [operations/machine-setup.md](../../operations/machine-setup.md).

Bu doküman `mustafakurtt/uniclub-frontend` reposu içindir.
...
aynısı, bkz. [machine-setup.md](../../operations/machine-setup.md)).
