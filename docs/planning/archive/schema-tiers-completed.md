# Şema, Ürün ve Doküman Yol Haritası (arşiv)

> **Tarihsel kayıt:** Tier 0/1 ve kapatılan doküman borcu (31 Tem 2026).
> Aktif backlog: [../schema-product.md](../schema-product.md).

Bu dosya **veri modeli**, **SaaS ürünleşme** ve **dokümantasyon** eksenindeki
borcu sıraya koyar. Güvenlik/core ekseni ayrı bir dosyada:
[security-core.md](../security-core.md).
...
> resend akışıyla yenisini alır. Ayrıntı: [MAIL_DOGRULAMA.md](../../architecture/mail-verification.md).
...
> `docs/compliance/kvkk.md`). Akış artık var, politika yazılabilir.
...
**Durum:** Runbook yazıldı — [ONBOARDING_TENANT.md](../../operations/tenant-onboarding.md).
...
[GUVENLIK_YOL_HARITASI Tier 1.3](../security-core.md).
...
Swagger UI. Bu madde bugün [GUVENLIK_YOL_HARITASI Tier 3](../security-core.md)'ün
...
|---|---|
| `docs/reference/data-model.md` | 20+ tablonun ER diyagramı (mermaid) + alan sözlüğü + "bu tabloda tenant kolonu var mı" sütunu. Bugün şema yalnızca kod yorumlarında anlatılıyor; bu yüzden Tier 0-3'teki eksikler görünmez kalmış. |
...
| `docs/compliance/kvkk.md` | Saklama süreleri, silme talebi akışı, hangi tablo kişisel veri taşıyor, işleme envanteri. operations.md "anonimleştir" diyor ama politika yazılı değil. Kurumsal alıcı sözleşme aşamasında ister. |
| `docs/operations/tenant-onboarding.md` | Yeni üniversite açma runbook'u (bkz. 2.3). |
