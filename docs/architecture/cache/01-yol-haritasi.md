...
> **YÜK TESTİ BU MADDEYİ İPTAL ETTİ** (2026-07-25, bkz. [PERFORMANS.md](../../operations/performance.md)).
...
Ölçümün tamamı → [docs/operations/performance.md](../../operations/performance.md). Özet:
