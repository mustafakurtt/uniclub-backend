...
İlgili: [DATA_MODEL.md](DATA_MODEL.md) · [operations.md](operations.md) ·
[DENETIM_VE_HATA.md](DENETIM_VE_HATA.md)
...
(bkz. [GUVENLIK_YOL_HARITASI.md](GUVENLIK_YOL_HARITASI.md) Tier 3).
...
Bunlar [operations.md](operations.md)'de de yazılı, burada kişisel veri açısından tekrarlanıyor:
